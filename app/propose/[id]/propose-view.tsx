          ...
          {sellerItems.map((item) => {
            ...
            return (
              <button
                ...
                className={`relative aspect-square w-full overflow-hidden rounded-xl border-2 transition-all active:scale-95 ${
              ...
              >
                ...
                {isTrigger && (
                  <div className="absolute bottom-0 left-0 right-0 bg-black/60 py-1 text-center text-[10px] font-bold text-white uppercase tracking-wider backdrop-blur-sm">
                    {t('preSelected')}
                  </div>
                )}
              </button>
                ...
                >
                  ...
                  {isLocked && (
                    <div className="absolute inset-0 flex flex-col items-center justify-center bg-black/40 text-white">
                      ...
                      <span className="text-[10px] font-bold uppercase tracking-wider">{t('locked')}</span>
                    </div>
                  )}
                  {!isLocked && isSelected && (
                    <div className="absolute inset-0 bg-primary/20" />
